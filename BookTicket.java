...
public class BookTicket extends AppCompatActivity {
    ...
    private void GetStringfromIntent(){
        ...
        seatNo = FirebaseDatabase.getInstance("https://ebus-3067a-default-rtdb.firebaseio.com/").getReference().
    ...
    private void Book_Ticket(){
        ...
        if(no_of_seat<=0){
            ...
            Confirming_ticket = FirebaseDatabase.getInstance("https://ebus-3067a-default-rtdb.firebaseio.com/").getReference().
                    child("Tickets").child(ST_Date).child(ST_Busnumber).child(User);


            DatabaseReference TicketID = FirebaseDatabase.getInstance("https://ebus-3067a-default-rtdb.firebaseio.com/").getReference().
                    child("Tickets").child("TicketID").child(ST_Date);


            DatabaseReference Ticket_Check_User_Admin = FirebaseDatabase.getInstance("https://ebus-3067a-default-rtdb.firebaseio.com/").
                    getReference().child("Tickets").child("Ticket_Check_User_Admin").child("On "+ST_Date + " by bus no "+ ST_Busnumber);

            DatabaseReference Ticket_User_Search = FirebaseDatabase.getInstance("https://ebus-3067a-default-rtdb.firebaseio.com/").
                    getReference().child("Tickets").child("Tickets_User_Search").child(User).child("On "+ST_Date + " by bus no "+ ST_Busnumber);

            DatabaseReference Ticket_HashCode = FirebaseDatabase.getInstance("https://ebus-3067a-default-rtdb.firebaseio.com/").getReference().child("Tickets").child("Ticket_HashCode").child(User);
