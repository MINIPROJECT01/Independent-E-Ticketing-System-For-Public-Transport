...
import com.example.busticketadmin.Interface.IFirebaseLoadDone;
import com.example.busticketadmin.Model.IDs;
...
public class AddBus extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener, AdapterView.OnItemSelectedListener, IFirebaseLoadDone {
    ...
    private void Initialize(){
        admin_name = FirebaseDatabase.getInstance("https://ebus-3067a-default-rtdb.firebaseio.com/").getReference().child("Admin");
    ...
    private void SendBusData(String busType,String dbBusNumber,
        ...
        StoringData = FirebaseDatabase.getInstance("https://ebus-3067a-default-rtdb.firebaseio.com/").getReference().
